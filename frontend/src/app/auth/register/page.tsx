        ...
        >
          ...
          <label className="block mb-6">
            ...
            <input
              ...
              className="mt-1 w-full px-4 py-2.5 bg-gray-800/80 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-700/50 focus:border-amber-700 transition"
            />
            <span className="text-xs text-gray-600 mt-1 block">Minimum 6 characters</span>
          </label>
          ...
          >
            {loading ? "Forging your destiny..." : "Begin Your Quest"}
          </button>

          <p className="mt-5 text-sm text-gray-500 text-center">
            Already an adventurer?{" "}
            <Link href="/auth/login" className="font-medium hover:underline" style={{ color: "#d4a843" }}>
              Sign In
            </Link>
          </p>
        </form>
